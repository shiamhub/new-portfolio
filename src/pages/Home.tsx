  ...
  return (
    <div id='home'>
      ...
      <div className='text-start absolute lg:top-1/4 top-[7%] lg:left-[10%] left-8 w-10/12'>
        ...
        <h6>Web Developer</h6>
        <p className='lg:w-7/12 w-3/5 hidden lg:block mt-2 text-black'>Welcome to my portfolio! Arafat Dayan is a MERN-Stack Web Developer, and a passion for creating Visually Stunning web experiences.</p>
